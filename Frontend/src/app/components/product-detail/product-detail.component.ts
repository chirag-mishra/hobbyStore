...
export class ProductDetailComponent implements OnInit {
    ...
    constructor(private route: ActivatedRoute, private router: Router, 
        ...
        //     _id: ""
        // }]
        this.productsObj=this.apiService.getProductDetails('5b96bba1355e53554ba9d6c6');
    ...
    ngOnInit(){
        ...
        this.reviewObj = this.productsObj.reviews;
        let bodyObject = {
    ...
    AddTotalQuantitytoCart() {
        ...
        localStorageWrapper.addToCart({ "productId": id, "quantity": this.productsObj.stock })
    }
